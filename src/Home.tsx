...
<div
    ...
    <div style={{ marginLeft: '38%' }}>
        <p style={{fontSize:'55px'}}>{days} : {hours} : {minutes} : {seconds}</p>
        ...
        marginLeft : '16px'
              ...
              <Other>
                {!guardStates.isStarted ? (
                  ...
                  <h1 style={{ marginLeft: '400px', marginBottom:'300px' }}>PLEASE CONNECT  YOUR PHANTOM WALLET  !</h1>
                ...
                {guardStates.isStarted && wallet.publicKey && (
                  <MintCount>
                   <p> Total minted {candyMachineV3.items.redeemed} /  
                    {candyMachineV3.items.available}{" "}</p>
